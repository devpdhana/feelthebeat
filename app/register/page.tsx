        ...
        <form onSubmit={handlePayment} className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <Card className="flex flex-col gap-6 p-6 md:p-8">
              <div className="border-b border-brand-primary/12 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
              ...
              <div className="rounded-lg border border-rose-500/20 bg-rose-500/10 p-3 sm:p-3.5 flex items-center gap-3 shadow-xs">
                ...
                <div className="font-mono text-[11px] sm:text-xs text-default leading-tight">
                  ...
                  <span className="text-muted-default">Online registrations for Feel The Beat Run 2026 are now officially closed.</span>
                </div>
              </div>
